...
class BartModel(BartPretrainedModel):
    ...
    def forward(
        ...
        return Seq2SeqModelOutput(
            ...
            encoder_last_hidden_state=encoder_outputs.last_hidden_state if isinstance(encoder_outputs, BaseModelOutput) else None,
            encoder_hidden_states=encoder_outputs.hidden_states if isinstance(encoder_outputs, BaseModelOutput) else None,
            encoder_attentions=encoder_outputs.attentions if isinstance(encoder_outputs, BaseModelOutput) else None,
        )
...
if __name__ == '__main__':
    model_path = '/remote-home/source/yfshao/bart-zh/arch12-2-new-iter2w/encoder'
    ...
    contexts = ["玩游戏这孩子在", "学习我不想每天"]
    # config = BartConfig.from_pretrained(model_path)
    encoder_config = BertConfig.from_pretrained('hfl/chinese-roberta-wwm-ext-large')
    ...
    inputs = tokenizer.batch_encode_plus(contexts, padding=True)
