...
def main():
    ...
    with contextlib.ExitStack() as stack:
        # open files
        # inputs = [
        #     stack.enter_context(gzip.open(input, 'rt', encoding='utf-8') if args.use_gzip else open(input, 'r', encoding='utf-8'))
        #     if input != "-"
        #     else sys.stdin
        ...
        # encoded_docs = pool.imap(encoder.encode_json, fin, args.workers * 10)
        encoded_files = pool.imap_unordered(encoder.encode_file, fin, 1)
