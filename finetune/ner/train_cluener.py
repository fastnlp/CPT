...
parser.add_argument("--dataset", help='path to data dir')
...
if demo:
    ...
    cache_fn = f"dataset/cache/cluener-{model_name}-{args.max_length}"
...
if get_local_rank() == 0:
    ...
    os.makedirs("logs/cluener", exist_ok=True)
    fitlog.set_log_dir("logs/cluener")
